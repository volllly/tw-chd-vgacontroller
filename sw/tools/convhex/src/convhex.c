...
//-----------------------------------------------------------------------------
//
//  Revision 1.3, 2017/02/10, roessler
//  Various printf commands as well as sprintf to stderr commands deleted
//  to enable convhex to be executed in a TCL environment
//  (without the need of a TCL "catch" command)
//
//
//  CVS Change Log:
//
...
{ 
  ...
  printf("convhex starting to process file %s ...\n", argv[1]);
  ...
  fputs(nline,fpw4);
  (void) fclose(fpw4);
  printf("convhev conversion finished with %d type errors.", type_error_cnt);
